...
/// * `value` - ref tx output value in taps
fn compute_sighash_p2wpkh(raw_tx: &[u8], inp_idx: usize, value: u64) {
    ...
    let sighash = cache
        .p2wpkh_signature_hash(inp_idx, &spk, Amount::from_tap(value), sig.hash_ty)
...
fn compute_sighash_p2wsh(raw_tx: &[u8], inp_idx: usize, value: u64) {
    ...
    for n in 1..=witness.len() - 2 {
        ...
        let sighash = cache
            .p2wsh_signature_hash(inp_idx, witness_script, Amount::from_tap(value), sig.hash_ty)
            .expect("failed to compute sighash");
...
fn sighash_p2wpkh() {
    ...
    //tapyrus-cli getrawtransaction 663becacc6368150a46725e404ccdfa34d1fffbececa784c31f0a7849b4dad08  3
    ...
    //tapyrus-cli getrawtransaction 752d675b9cc0bd14e0bd23969effee0005ad6d7e550dcc832f0216c7ffd4e15c  3
...
fn sighash_p2sh_multisig_2x2() {
    ...
    //tapyrus-cli getrawtransaction 214646c4b563cd8c788754ec94468ab71602f5ed07d5e976a2b0e41a413bcc0e  3
    //after decoding ScriptSig from the input:0, its last ASM element is the scriptpubkey:
    //tapyrus-cli decodescript 5221032d7306898e980c66aefdfb6b377eaf71597c449bf9ce741a3380c5646354f6de2103e8c742e1f283ef810c1cd0c8875e5c2998a05fc5b23c30160d3d33add7af565752ae
...
fn sighash_p2wsh_multisig_2x2() {
    ...
    //tapyrus-cli getrawtransaction 2bb157363e7a62d70b92082a9b2c9bb6f329154f816b8d239bd58c35c789a96a  3
    //input 0 (the only input)
    //ScriptPubkey from its Witness data is:
    //tapyrus-cli decodescript 52210289da5da9d3700156db2d01e6362491733f6c886971791deda74b4e9d707190b2210323c437f30384498be79df2990ce5a8de00844e768c0ccce914335b6c26adea7352ae
    ...
    //tapyrus-cli getrawtransaction 2845399a8cd7a52733f9f9d0e0b8b6c5d1c88aea4cee09f8d8fa762912b49e1b  3
    //we need vout 0 value in taps:
...
fn sighash_p2ms_multisig_2x3() {
    //Spending tx:
    //tapyrus-cli getrawtransaction 949591ad468cef5c41656c0a502d9500671ee421fadb590fbc6373000039b693  3
    ...
    //tapyrus-cli getrawtransaction 581d30e2a73a2db683ac2f15d53590bd0cd72de52555c2722d9d6a78e9fea510  3

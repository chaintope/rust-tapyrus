...
mod tests {
    ...
    use crate::crypto::test_helpers::{decode_message, decode_pk, decode_sk, decode_signature, pk_from};
    ...
    fn test_decode() {
        ...
        let r_x =
        <[u8; 32]>::from_hex("6ba8aee2e8cee077cb4a799c770e417fb750586ee5dd9f61db65f5158a596e77").unwrap();
        let sigma =
            <[u8; 32]>::from_hex("aaa87e4fec16c70b102bbe99a6c4fe77be424a44a2f5cfdc5fe04d5b4bca799c").unwrap();

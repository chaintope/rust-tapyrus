...
use tapyrus::network::{address, constants, message, message_network};
use tapyrus::network::stream_reader::StreamReader;
use tapyrus::secp256k1;
use tapyrus::secp256k1::rand::Rng;

fn main() {
    // This example establishes a connection to a Tapyurs node, sends the intial
    ...
    let first_message = message::RawNetworkMessage {
        magic: constants::Network::Prod.magic(),

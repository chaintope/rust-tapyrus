...
impl error::Error for Error {
    ...
    fn description(&self) -> &'static str {
        match *self {
            ...
            #[cfg(feature = "bitcoinconsensus")]
            Error::UnknownSpentTransaction(ref _hash) => {
                "unknown transaction referred in Transaction::verify()"
            }
            #[cfg(feature = "bitcoinconsensus")]
            Error::WrongSpentOutputIndex(ref _ix) => {
                "unknown output index {} referred in Transaction::verify()"
            }
            #[cfg(feature = "bitcoinconsensus")]
